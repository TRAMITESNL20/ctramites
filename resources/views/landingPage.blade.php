<div class="w-100 fixed " style="top:0;position:fixed;height:70px">
            <div class="  w-100 " style="background-color:#3ba3fb;position: relative;display: flex;flex-wrap: wrap;align-items: center;padding: 0.5rem 1rem;">
                <img src="images/logo.svg" style="color:white" width="200" height="50">
                <a class="text-white" href="#">VENTANILLA UNICA DIGITAL</a>
                <div style="right:0;margin-left:auto" class="text-white">
                    <span class="text-uppercase text-white" style="font-size:12px">captura tu folio de segumiento</span><input  class="input w-25 pl-4" style="background-color:white;margin-left:20px" type="text">
                    <span class="text-white px-12" style="font-size:8px">OBTEN TU CFDI</span>
...
<div class="w-100 " style="margin-top:30%;    background-color: aliceblue;">
    ...
    <div class="d-flex flex-column-fluid" style="background-color:#f1f8fe">
