                ...
                <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap" :class="!group ? 'mt-2' : ''">
                        ...
                        <div class="mr-auto" v-bind:style="[ cartComponent ? { width : '60%' } : { width: '50%' } ]">
                            ...
                            <a v-on:click="goTo(tramite)" class="d-flex text-dark over-primary font-size-h5 font-weight-bold mr-3 flex-column">
                                ...
                                <span :class="group ? '' : 'text-muted'" v-if="type !== undefined && tramite.info && !group">
                                    <span style="font-weight: normal;" v-if="tramite.tramites[0] && tramite.tramites[0].id_transaccion_motor"><strong>FOLIO PAGO:</strong> {{ tramite.tramites[0] && tramite.tramites[0].id_transaccion_motor ? `${tramite.tramites[0].id_transaccion_motor} -` : '' }}</span>
                                    <span style="font-weight: normal;" v-if="tramite.id"><strong>FSE:</strong> {{ tramite.tramites[0] ? tramite.tramites[0].id : '' }}</span>
                                </span>
                        ...
                        <div class="my-lg-0 my-1 d-flex flex-column">
                            ...
                            <a v-on:click="goTo(tramite.tramites[0].url_recibo, true)" class="btn btn-sm btn-primary font-weight-bolder text-uppercase text-white mt-2" v-if="tramite.tramites[0] && tramite.tramites[0].url_recibo && [2,3].includes(type) && !group">VER RECIBO DE PAGO</a>
