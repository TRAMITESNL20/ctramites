                ...
                <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap" :class="!group ? 'mt-2' : ''">
                        ...
                        <div class="my-lg-0 my-1 d-flex flex-column">
                            ...
                            <a v-on:click="goTo(tramite.doc_firmado, true)" class="btn btn-sm btn-primary font-weight-bolder text-uppercase text-white mt-2" v-if="tramite.doc_firmado && [2,3].includes(type) && !group && tramite.required_docs != 0 ">VER DECLARACIÓN</a>
